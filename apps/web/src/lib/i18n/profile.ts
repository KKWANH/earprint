...
const ko: typeof en = {
  ...
  introText:
    "좋아요 라이브러리의 장르·무드·아티스트 분포를 Gemini 가 해석해 취향과 성격을 프로파일링합니다. 분석을 더 돌릴수록 정확해집니다.",
  generatedAt: "생성일:",
  constellationTitle: "취향 별자리",
  constellationDesc:
    "장르를 별로, 같은 곡에 함께 태그된 장르를 선으로 잇습니다. 자주 섞어 듣는 장르일수록 가까이 모입니다.",
  noProfile:
    "아직 AI 분석이 없습니다. 위 버튼으로 만드세요. (라이브러리 분석을 먼저 돌리면 장르·무드 데이터가 채워져 더 정확해집니다.)",
  diggingScore: "디깅 점수",
  ...
  feelAcoustic: "어쿠스틱",
  localeMismatch:
    "이 분석은 다른 언어로 작성됐습니다 — 한국어로 보려면 다시 생성하세요.",
  capped:
