...
const en = {
  ...
  mbtiHeading: "Music MBTI",
  mbtiAxisMainstream: "Mainstream",
  mbtiAxisNiche: "Niche",
  mbtiAxisAcoustic: "Acoustic",
  mbtiAxisElectronic: "Electronic",
  mbtiAxisCalm: "Calm",
  mbtiAxisVigorous: "Vigorous",
  mbtiAxisFamiliar: "Familiar",
  mbtiAxisExploratory: "Exploratory",
...
const ko: typeof en = {
  ...
  mbtiHeading: "음악 MBTI",
  mbtiAxisMainstream: "메인스트림",
  mbtiAxisNiche: "인디",
  mbtiAxisAcoustic: "어쿠스틱",
  mbtiAxisElectronic: "일렉트로닉",
  mbtiAxisCalm: "차분",
  mbtiAxisVigorous: "격렬",
  mbtiAxisFamiliar: "익숙",
  mbtiAxisExploratory: "모험",
