...
const ko: Dict = {
  ...
  landing: {
    tagline: "내가 좋아하는 음악, 왜 좋아하는지",
    intro:
      "Earprint 는 유튜브 뮤직 좋아요 곡을 모아, 연말 결산 차트가 아닌 음악 심리학 기반의 진짜 취향 분석으로 바꿉니다.",
    ctaIn: "내 대시보드 열기 →",
    ctaOut: "Google 로 로그인",
    signedInAs: "로그인:",
    scienceTitle: "내가 듣는 음악을 비추는 거울",
    scienceBody:
      "대부분의 음악 앱은 '무엇을 들었는지'만 보여줍니다. Earprint 는 '왜 좋아하는지'를 설명합니다. 예측이 맞을 때 뇌가 주는 보상, 10대의 음악을 평생 남게 만드는 회상 효과, 개방성이 빚어내는 취향 궤적 — 세 가지 연구를 바탕으로 합니다.",
    featuresTitle: "주요 기능",
    f1Title: "라이브러리 대시보드",
    ...
    f3Title: "아티스트 맵",
    f3Body: "내 아티스트들의 관계를 한눈에. 안 들어본 연관 아티스트도 한 번에 추가.",
    f4Title: "추천",
    f4Body: "5가지 발견 모드, 스와이프로 평가 — 평가에 따라 다음 추천이 달라집니다.",
    howTitle: "사용 방법",
    s1: "크롬 확장프로그램 설치",
    ...
    gallerySubtitle:
      "좋아요한 곡을 공유할 수 있는 음악 캐릭터로 만듭니다. 아래는 예시입니다.",
