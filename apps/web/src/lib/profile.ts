...
[작성 지시]
- 한국어로, 친근하면서도 날카롭게.
- persona: 이 리스너를 하나의 '음악 캐릭터'로 의인화. 별자리·캐릭터·시대별 음악인 같은 느낌으로 재미있고 공유하고 싶게.
  · name: 개성 있고 멋진 한국어 별칭 (예: "심야의 시티팝 항해자", "을씨년스러운 디스코의 수호자").
  · archetype: 유형을 한 단어~짧은 구로 (예: "몽상가형 디거", "장르 유목민").
  · emoji: 이 캐릭터를 대표하는 이모지 1개.
  · tagline: 임팩트 있는 한 줄.
