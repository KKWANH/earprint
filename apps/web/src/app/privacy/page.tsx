...
const en = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "We use the information we collect to: (a) authenticate you and operate your account; (b) analyze your music taste and generate your dashboard, Taste DNA, psychology-style profile, artist map, and recommendations; (c) operate, secure, maintain, and improve the Service; (d) process payments and provide customer support for paid features, if offered; and (e) comply with legal obligations.",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "(나) 음악 메타데이터 — YouTube Music 에서 \"좋아요\"한 곡 정보. 각 곡당 저장 항목: 제목, 아티스트, 앨범(있을 경우), YouTube Music videoId, 좋아요 목록 내 위치, 좋아요 시간(YouTube 가 노출하는 경우). 이 목록은 Earprint 확장프로그램이 이용자 본인의 로그인 세션에서 수집하여 계정에 업로드합니다. 운영자는 다음을 수집·저장·처리하지 않습니다: YouTube 비밀번호, Google 비밀번호, YouTube 재생 기록, YouTube 시청 기록, YouTube 검색 기록, YouTube 댓글, 구독 목록, 영상 썸네일, 동영상 콘텐츠 자체. UI 에 표시되는 앨범 커버 아트는 별도로 Deezer 공개 카탈로그에서 가져오며, 이용자의 YouTube 세션과 무관합니다.",
